...
export class BasededatosService {
  ...
  registroUsuario: string = "INSERT or IGNORE INTO usuario(correo,nombre,apellido,telefono,contrasennia,tR_idRol) VALUES ('a@a.com','Ignacio','Salas Messi',12345678,'123','../assets/Imagenes/Shalas.webp',2);";
  registroUsuario2: string = "INSERT or IGNORE INTO usuario(correo,nombre,apellido,telefono,contrasennia,tR_idRol) VALUES ('b@a.com','Hugo','Salas Messi',87654321,'123','../assets/Imagenes/usuario.jpeg',1);";
